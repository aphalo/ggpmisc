...
give access to extensions moved to package '**ggpp**'. New geoms support
...
loaded, but the documentation now resides in the new package '**ggpp**'. 
...
package 'ggpmisc' before version 0.3.0 are now in package '**gginnards**'.
...
ggplot(cars, aes(speed, dist)) +
  geom_point() +
  geom_quant_line(formula = formula, quantiles = 0.5) +
