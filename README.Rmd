...
+==========================+===================================================+================================================+
| `stat_poly_eq()`         | equation, *R*<sup>2</sup>, *P*, etc. (`text_npc`) | lm, rlm (1, 2) |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_ma_eq()`           | equation, *R*<sup>2</sup>, *P*, etc. (`text_npc`) | lmodel2: MA, SMA, RMA, OLS                     |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_quant_eq()`        | equation, *P*, etc. (`text_npc`)                  | rq: br, fn, pfn, sfn, fnc, conquer, pfnb, qfnb, ppro, lasso. (1, 3, 4)   |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_correlation()`      | correlation, _P_-value, CI (`text_npc`)           | Pearson (_t_), Kendall (_z_), Spearman (_S_)   |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_poly_line()`       | line + conf. (`smooth`)                           | lm, rlm (1, 2) |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_ma_line()`         | line + conf. (`smooth`)                           | lmodel2: MA, SMA, RMA, OLS                     |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_quant_line()`      | line + conf. (`smooth`)                           | rq: br, fn, pfn, sfn, fnc, conquer, pfnb, qfnb, ppro, lasso; rqss: sfn. (1, 3, 4)             |
+--------------------------+---------------------------------------------------+------------------------------------------------+
| `stat_quant_band()`      | median + quartiles (`smooth`)                     | rq, rqss (1, 4, 5)           |
+--------------------------+---------------------------------------------------+------------------------------------------------+
