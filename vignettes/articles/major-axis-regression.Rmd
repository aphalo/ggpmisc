...
The functions for major axis regression from package 'smatr' behave similarly
to `lm` and other R model fit functions and accessors to the components of the
model fit object are available.
...
ggplot(my.data, aes(x, y)) +
  ...
  stat_poly_eq(method = smatr::ma, 
             mapping = use_label("eq", "R2", "n", "AIC", "BIC"))
```
