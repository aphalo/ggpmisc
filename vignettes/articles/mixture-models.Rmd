...
## Fitted models in `stat_distrmix_line()` and `stat_normal_eq()`

Both `stat_distrmix_line()` and `stat_normal_eq()` are designed for flexibility while still attempting to keep 
...
ggplot(faithful, aes(x = waiting)) +
  ...
  stat_distrmix_line(aes(colour = after_stat(component),
                      ...
                      fit.seed = 123) +
  stat_distrmix_eq(aes(colour = after_stat(component)), fit.seed = 123) +
...
ggplot(faithful, aes(x = waiting)) +
  ...
  stat_distrmix_line(aes(colour = after_stat(component),
                      ...
                      outline.type = "upper",
                      geom = "area", linewidth = 1, alpha = 0.25,
                      components = "members", fit.seed = 123) +
...
```{r, warning=FALSE, results='hide', fig.keep='all'}
 ggplot(faithful, aes(x = waiting)) +
  ...
  stat_distrmix_line(geom = "area", linewidth = 1, alpha = 0.25,
                      ...
                      components = "sum", se = FALSE, fit.seed = 123) +
...
```{r, warning=FALSE, results='hide', fig.keep='all'}
 ggplot(faithful, aes(x = waiting)) +
  ...
  stat_distrmix_line(geom = "area", linewidth = 1, alpha = 0.25,
                      colour = "black", outline.type = "upper",
                      components = "sum", se = FALSE, fit.seed = 123) +
  stat_distrmix_eq(components = "sum", fit.seed = 123, se = TRUE) +
  expand_limits(y = 0.06) # make space for the equation above the histogram
```
...
ggplot(faithful, aes(x = waiting)) +
  ...
  stat_distrmix_line(aes(colour = after_stat(component),
                      ...
                      geom = "area", linewidth = 1, alpha = 0.25,
                      fit.seed = 123, k = 1) +
  stat_distrmix_eq(aes(colour = after_stat(component)), se = TRUE,
                    fit.seed = 123, k = 1)
```
...
ggplot(data.frame(speed = galaxies * 1e-3), aes(x = speed)) +
  ...
  stat_distrmix_line(aes(colour = after_stat(component),
                      ...
                      k = 3, fit.seed = 123) +
  stat_distrmix_eq(aes(colour = after_stat(component)), 
                    k = 3, fit.seed = 123, geom = "label_npc", size = 3.2) +
...
ggplot(data.frame(speed = galaxies * 1e-3), aes(x = speed)) +
  geom_histogram(aes(y = after_stat(density)), alpha = 0.33, bins = 20) +
  stat_distrmix_line(outline.type = "upper", colour = "black",
                      geom = "area", linewidth = 1, alpha = 0.25,
                      k = 6, fit.seed = 123, components = "sum") +
  stat_distrmix_line(outline.type = "upper", colour = "black",
                      geom = "line", linewidth = 0.25,
                      k = 6, fit.seed = 123, components = "members") +
  stat_distrmix_eq(k = 6, fit.seed = 123, components = "members", 
