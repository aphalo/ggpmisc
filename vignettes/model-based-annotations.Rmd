...
### stat_quant_eq() and stat_quant_line()
...
has the same user interface and default arguments as `stat_quant_eq()` supports 
both _x_ and _y_ as explanatory variable in formula` and also `orientation`.
