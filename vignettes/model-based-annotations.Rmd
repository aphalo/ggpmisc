...
fitting function and arguments. By default this _statistic_ behaves similarly as
`ggplot2::stat_smooth` with `method = "lm"` for _y_ on _x_ fits but adds support
for model formulas of _x_ on _y_ (in addition to the use of `orientation =
