...
output: 
  rmarkdown::html_vignette:
    toc: yes
vignette: >
  %\VignetteIndexEntry{GG and annotations}
...
labels* irrespective if the "labels" are texttual or graphical, like
...
considered fairly stabl. However, this implementation is to an extent
...
geoms as are dealing with data labels or data points.
