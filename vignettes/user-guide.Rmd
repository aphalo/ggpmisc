...
my.data <- data.frame(x = x,
                      ...
                      y.poly = y.poly,
                      y.poly.grp = y.poly * c(1, 2) + c(0, 0.5),
                      wght.sqrt = sqrt(x),
                      group = c("A", "B"),
...
Weighted residuals are available, and in this case they differ from the raw residuals as we have mapped any variable `wght.otlr` to the `weight` aesthetic. Compare the two figures below.
...
ggplot(my.data.outlier, aes(x, y.poly)) +
