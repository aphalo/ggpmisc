...
named `grp.label`. (Labelling uses a "back door" in 'ggplot2' that may be closed
in future versions, meaning that this approach to labelling may stop working in the future.)
