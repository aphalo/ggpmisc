...
This statisitc automates the annotation of plots with number of observations,
...
Pooling qudrants along the _x_-axis.
...
Manual positioning of the text annotations and pooling of all four quadrats.
...
Here we higlight the observations split in three group equal groups, each of a
...
One example with the gamma distribution, which is asymetric.
