...
As any valid R expression can be used, greek letters are also supported, as well as the inclussion in the label of variable transformations used in the model formula.
